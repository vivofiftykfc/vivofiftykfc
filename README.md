...
| **Tools** | Git, ncnn, cross-compilation toolchains, Claude Code |
...
| [**cicc_9**](https://github.com/vivofiftykfc/cicc_9) | 2025 National IC Innovation Competition, North China 2nd Prize — drone assistant: IR thermal imaging + object detection + OpenAMP | C++ + ncnn + OpenAMP |
| [**JokerTetris**](https://github.com/vivofiftykfc/JokerTetris) | Gravity-variant Tetris with sand physics and color-matching elimination | Python + Pygame |
| [**Contemplation Site**](https://github.com/vivofiftykfc/contemplation-site) | One-click meditations-style reading website generator | React + Vite + Tailwind CSS |
...
| **工具链** | Git、ncnn 推理框架、交叉编译工具链、Claude Code |
...
| [**cicc_9**](https://github.com/vivofiftykfc/cicc_9) | 集创赛 2025 华北赛区二等奖 — 飞腾派无人机辅助系统：红外热成像 + NanoDet 目标检测 + OpenAMP 双核超声避障 | C++ + ncnn + OpenAMP |
| [**JokerTetris**](https://github.com/vivofiftykfc/JokerTetris) | 重力版俄罗斯方块 — 方块分解为沙粒自由下落，同色消除机制 | Python + Pygame |
